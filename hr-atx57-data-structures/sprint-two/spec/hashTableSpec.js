describe('hashTable', function() {
  ...
  it('should not store multiple values for the same key', function() {
    hashTable.insert('Siddhartha', 'Gautama');
    hashTable.insert('Siddhartha', 'Buddha');
    expect(hashTable.retrieve('Siddhartha')).to.equal('Buddha');
  });
